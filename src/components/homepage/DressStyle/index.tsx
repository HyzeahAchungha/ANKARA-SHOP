      ...
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        ...
        >
          <DressStyleCard
            title="Casual"
            url="/shop#casual"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[130px] bg-[url('/images/formal.jpg')]"
          />
          <DressStyleCard
            title="Formal"
            url="/shop#formal"
            className="md:max-w-[684px] h-[130px] bg-[url('/images/HERO.jpeg')]"
          />
        </motion.div>
        <motion.div
          initial={{ y: "100px", opacity: 0 }}
        ...
        >
          <DressStyleCard
            title="Party"
            url="/shop#party"
            className="md:max-w-[684px] h-[80px] bg-[url('/images/casualware.jpg')]"
          />
