      ...
      >
        ...
        {viewAllLink && (
          <div className="w-full px-4 sm:px-0 text-center">
            <Link
              href={viewAllLink}
              className="w-full inline-block sm:w-[218px] px-[54px] py-4 border rounded-full bg-primary text-primary-foreground hover:bg-secondary hover:text-white  rounded-tl-none  transition-all font-medium text-sm sm:text-base border-black/10
